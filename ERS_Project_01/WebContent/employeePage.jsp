...
<body>
	<jsp:scriptlet>
		request.getSession().setAttribute("previousPage", "employeePage.jsp");
			...
			<div class="navbar-header">
				<a class="navbar-brand"></a>
					<ul class="nav navbar-nav">
						...
						<li><a class="navbar-brand" href="OpenReimbursements">View Pending Reimbursements</a></li>
						<li><a class="navbar-brand" href="ResolvedReimbursements">View Resolved Reimbursements</a></li>
					</ul>
			</div>
		</div>
