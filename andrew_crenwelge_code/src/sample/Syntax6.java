...
public class Syntax6 {
	...
	public static void main(String[] args) {
		...
		if (true)
			System.out.println("If statements print when evaluated to true");
		if (false)
			System.out.println("This dead code will never print!");
		else
			System.out.println("Else statements print when the evaluated expression is false");
		String var = "a string";
		switch(var) {
