...
function changePassword(){
	...
	var changingPassword = document.getElementById("oldpass").value;
	var jhttp;
	if(newpassa == newpassb){
		jhttp = new XMLHttpRequest();
		passwords = new Object();
		passwords.oldPassword = changingPassword;
		passwords.newPassword = newpassa;
	...
	jhttp.send(JSON.stringify(passwords));
