...
<div class="container">
      ...
      <main role="main">
       ...
       <td> <a href='updateOneSuccess.do?rid="${name.getRid()}"' class='btn btn-default'>Approved</a></td>
       <td> <a href='updateTwoDenied.do?rid="${name.getRid()}"'  class='btn btn-primary'>Deny</a></td>
       </tr>
       </c:forEach>
       </tbody>
        </table>				
